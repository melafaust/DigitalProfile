...
/* â”€â”€ Official Microsoft brand SVGs (not in simple-icons) â”€â”€ */
...
const AzureDataFactorySvg = () => (
  <svg viewBox="0 0 18 18" className="w-8 h-8" fill="none">
    <defs>
...
const skills: Skill[] = [
  ...
  },
  {
    name: "MySQL",
    color: "#4479A1",
    icon: <SiMysql style={{ width: 32, height: 32, color: "#4479A1" }} />,
  },
  {
    name: "Power Apps",
    color: "#742774",
  ...
  },
  {
    name: "Python",
    color: "#3776AB",
    icon: <SiPython style={{ width: 32, height: 32, color: "#3776AB" }} />,
  },
  {
    name: "C++",
    color: "#00589D",
    icon: <SiCplusplus style={{ width: 32, height: 32, color: "#00589D" }} />,
  },
  {
    name: "API Testing",
    color: "#FF6C37",
    icon: <SiPostman style={{ width: 32, height: 32, color: "#FF6C37" }} />,
  },
  {
    name: "CI/CD",
    color: "#2088FF",
    icon: <SiGithubactions style={{ width: 32, height: 32, color: "#2088FF" }} />,
  },
  {
    name: "Git",
    color: "#F05032",
    icon: <SiGit style={{ width: 32, height: 32, color: "#F05032" }} />,
  },
  {
    name: "Agile",
    color: "#EC4899",
  ...
  },
  {
    name: "Electron",
    color: "#47848F",
    icon: <SiElectron style={{ width: 32, height: 32, color: "#47848F" }} />,
  },
  {
    name: "Node.js",
    color: "#339933",
    icon: <SiNodedotjs style={{ width: 32, height: 32, color: "#339933" }} />,
  },
  {
    name: "LLM / Groq",
    color: "#F55036",
...
export default function Skills() {
  return (
    <section id="skills" className="relative scroll-m-32">
      ...
      <StaggerGrid className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        {skills.map((skill) => (
          <AnimCard key={skill.name}>
            <div
              className="flex flex-col items-center gap-3 p-4 rounded-xl bg-card/40 border border-white/5 hover:border-white/20 hover:bg-card/70 transition-all duration-300 group cursor-default h-full"
            >
              <div
              ...
              <span className="text-xs font-mono text-center text-muted-foreground group-hover:text-foreground transition-colors leading-tight">
                {skill.name}
              </span>
            </div>
          </AnimCard>
