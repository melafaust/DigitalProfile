...
const testimonials = [
  // ── Top 5 (fixed order) ─────────────────────────────────────────────────────
  {
    ...
    role: "Developer Lead",
    highlights: [
      "strong technical capability and initiative",
      "significantly reduced the team's manual effort",
      "measurable impact on team efficiency",
      "integrate automations with Gen AI",
    ],
  ...
  },
  {
    ...
    highlights: [
      "one of the valuable members of the team",
      "deliver medium to complex requirements",
      "proactive on her career",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "raising the overall engineering bar",
      "Your impact extends beyond your own work and is felt across the broader team",
      "well-positioned for expanded responsibility",
    ],
  ...
  },
  {
    ...
    highlights: [
      "emerged as Champion in Q1 FY26.2",
      "often goes beyond expectations",
      "strong technical capability and ownership",
      "more capable than she often gives herself credit for",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "initiative in creating an automation solution that substantially reduced manual work",
      "well-positioned to take on greater ownership",
    ],
  ...
  // ── Rest ────────────────────────────────────────────────────────────────────
  {
    ...
    highlights: [
      "exceptional technical capability and teamwork",
      "significantly streamlined our rerun process",
      "strong senior-level qualities",
      "capability and mindset of a seasoned developer",
    ],
  ...
  },
  {
    ...
    role: "QA Tester",
    highlights: [
      "continuous growth and strong initiative",
      "steps up to take on complex user stories without hesitation",
  ...
  },
  {
    ...
    role: "Developer, Teammate",
    highlights: [
      "very helpful and consistently proactive",
      "significantly reduced manual effort and improved overall efficiency",
    ],
  ...
  },
  {
    ...
    role: "Developer, Teammate",
    highlights: [
      "significant positive impact on my growth",
      "consistently guided me through different processes",
      "extremely valuable",
      "strong teamwork and a collaborative mindset",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "how open and teachable you've become",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "confidently taking on new opportunities",
    ],
  ...
  },
  {
    ...
    highlights: [
      "how proactive she is",
      "goes above and beyond",
      "dependability",
      "you have so many things to offer with the skills that you have",
    ],
...
function renderFeedback(text: string, highlights: string[]) {
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div className="max-h-64 overflow-y-auto pr-1 text-muted-foreground text-sm leading-relaxed whitespace-pre-line scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                {renderFeedback(t.feedback, t.highlights)}
              </div>
